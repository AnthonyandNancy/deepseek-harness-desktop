...
const platformConfig = {
  mac: {
    ...
    href: "https://github.com/AnthonyandNancy/deepseek-harness-desktop/releases/latest",
    iconPath:
  ...
  windows: {
    ...
    href: "https://github.com/AnthonyandNancy/deepseek-harness-desktop/releases/download/v0.3.5/DeepSeek-Harness-Desktop-0.3.5-windows-x64.exe",
    iconPath:
  ...
  linux: {
    ...
    href: "https://github.com/AnthonyandNancy/deepseek-harness-desktop/releases/download/v0.3.5/DeepSeek-Harness-Desktop-0.3.5-linux-x86_64.AppImage",
    iconPath:
...
const terminalCommands = {
  ...
  source: "$ git clone https://github.com/AnthonyandNancy/deepseek-harness-desktop",
};
